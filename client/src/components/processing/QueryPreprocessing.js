            ...
            <Box sx={{ p: 3 }}>
              ...
              <Card sx={{ mb: 2, bgcolor: '#e3f2fd' }}>
                <CardContent>
                  ...
                  <Box sx={{ mt: 1 }}>
                    <Chip label={`${preprocessResult.metadata?.tokens?.length || 0} tokens`} size="small" />
                  </Box>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                    ...
                    {preprocessResult.synonymExpanded?.length > 3 && (
                      <Typography variant="caption" color="text.secondary">
                        + {(preprocessResult.synonymExpanded?.length || 0) - 3} more variations
                      </Typography>
                    )}
                  </Box>
                </CardContent>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={6} sm={3}>
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 'bold' }}>
                      {preprocessResult.metadata?.processingTime || 0}ms
                    </Typography>
                  </Grid>
                  <Grid item xs={6} sm={3}>
                    <Typography variant="caption" color="text.secondary">
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 'bold' }}>
                      {preprocessResult.metadata?.tokens?.length || 0}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} sm={3}>
                    <Typography variant="caption" color="text.secondary">
                  ...
                  <Accordion>
                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography variant="subtitle2">
                        Synonym Mappings ({preprocessResult.metadata?.synonymMappings?.length || 0})
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <TableContainer>
                              ...
                              <TableRow key={idx}>
                                ...
                                <TableCell>
                                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                    ...
                                    )) || <Typography variant="caption" color="text.secondary">No synonyms</Typography>}
                                  </Box>
                                </TableCell>
                                <TableCell>{mapping.position}</TableCell>
                              </TableRow>
